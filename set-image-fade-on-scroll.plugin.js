/**
* @plugin: Image Fade On Scroll
* @version: 0.1
* @website: Squareplugs.com
* @description: Image Fade On Scroll Plugin for Squarespace
* @author: Zeddicus Zu'l Zorander <jimenez.phillip.felicidario@gmail.com>
*/
function setImageFadeOnScroll(t) {
	void 0 === t ? console.error("ImageFadeOnScroll Parameters is undefined.") : (callImageFadeOnScroll(t), $(window).on("popstate", function (i, n) {
		$("body div:last-child div:nth-child(3)").bind("DOMSubtreeModified", function () {
			callImageFadeOnScroll(t), $(this).off("DOMSubtreeModified")
		})
...
function callImageFadeOnScroll(t) {
	var i = {};
